...
This document describes how to create releases for the store-website project.
...
```bash
$ bun run release
Enter tag name (e.g., 1.0.0 or v1.0.0): 1.1.0
...
✓ Release 1.1.0 created and pushed successfully!
  - Commit: abc123def456
  - Tag: 1.1.0
...
3. Enter the tag name (e.g., `1.1.0`)
...
2. **bun.lock** - `version` field and `packages[""].version` updated
