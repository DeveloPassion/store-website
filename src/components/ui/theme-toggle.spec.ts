...
describe('ThemeToggle (logic tests)', () => {
    ...
    describe('styling classes', () => {
        test('contains expected base classes', () => {
            const className = 'bg-primary/10 hover:bg-primary/20 flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg transition-all duration-300 hover:scale-105 active:scale-95 lg:h-11 lg:w-11 xl:h-12 xl:w-12'
