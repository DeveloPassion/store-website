...
- **Assets**: 194 screenshots copied to `documentation/assets/osk/`
...
- **Permalink**: tbdlrt
- **Price**: €49
- **Assets**: Hosted on voice-ai.knowii.net and docs.voice-ai.knowii.net (no files to copy)
...
- **Permalink**: wazqkq
- **Price**: €69.99
- **Assets**: Hosted on knowledge-management-for-beginners.com (no files to copy)
- **Status**: Complete - ready for implementation
- **Extraction Date**: 2026-01-05
...
- **Bonuses**: $270+ included (OSK, courses, workshops, library)
- **Status**: Complete - ready for implementation
- **Extraction Date**: 2026-01-05
...
- **Status**: Not started
- **Note**: Dynamic bundle that includes multiple products
...
- **Status**: Not started
- **Note**: May not need product page - likely just informational page

---

## Next Product to Extract

**QUESTION FOR USER**: Which product should I extract next?
...
4. ✅ Identify features, benefits, included items
5. ✅ Select hero testimonials (if available)
6. ✅ Document media assets (videos, screenshots, cover images)
7. ✅ Copy asset files to documentation folder
8. ✅ Define FAQ entries
9. ✅ Specify cross-sell products
10. ✅ Create sales copy markdown file
11. ✅ Ask detailed questions for any missing/ambiguous data
...
```
~/wks/store-website/documentation/
├── SALES_COPY_EXTRACTION_STATUS.md (this file)
├── product-sales-copy-obsidian-starter-kit.md ✅
├── product-sales-copy-[next-product].md
├── ...
└── assets/
    ├── osk/ (194 files) ✅
    ├── knowii-voice-ai/
...
- **2 products completed**: ~1.5 hours total
- **19 products remaining**: ~14 hours total
- **Realistic timeline**: 3-4 days of focused extraction work (if done sequentially one-by-one)
- **Current pace**: ~45 minutes per product (including questions, verification, documentation)

**Optimization Strategy**: Batch similar products together (workshops, courses, etc.) to streamline questioning and asset gathering.
